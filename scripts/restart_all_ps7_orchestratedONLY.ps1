...
# Alle relevanten Ports inkl. 5004 (soll nicht laufen)
$ports = 5001,5002,5004,5173,8088
...
# Wartezeit bevor Caddy startet (damit 5002 komplett initialisiert)
Write-Host ("[WAIT] Warte {0}s bevor Caddy startet..." -f $CaddyDelaySec) -ForegroundColor DarkCyan
Start-Sleep -Seconds $CaddyDelaySec
...
Write-Host "[DONE] Neustart-Sequenz abgeschlossen." -ForegroundColor Green
