@echo off
REM ================================
REM HAK_GAL START - ABSOLUTE PFADE
REM ================================
REM Verwendet absolute Pfade für venv_hexa

title HAK_GAL Startup
color 0A
...
echo       Wechsle zu src_hexagonal...
start "API :5002" cmd /k "cd /d D:\MCP Mods\HAK_GAL_HEXAGONAL\src_hexagonal && D:\MCP Mods\HAK_GAL_HEXAGONAL\.venv_hexa\Scripts\python.exe hexagonal_api_enhanced_clean.py"
timeout /t 3 >nul
...
start "Dashboard :5000" cmd /k "cd /d D:\MCP Mods\HAK_GAL_HEXAGONAL && D:\MCP Mods\HAK_GAL_HEXAGONAL\.venv_hexa\Scripts\python.exe hakgal_dashboard_no_psutil.py"
timeout /t 1 >nul

echo [4/5] Starting Prometheus (Port 8000)...
start "Prometheus :8000" cmd /k "cd /d D:\MCP Mods\HAK_GAL_HEXAGONAL && D:\MCP Mods\HAK_GAL_HEXAGONAL\.venv_hexa\Scripts\python.exe hakgal_prometheus_optimized.py"
timeout /t 1 >nul
