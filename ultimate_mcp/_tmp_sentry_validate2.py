...
TOOLS = [
  ("sentry_test_connection", {}, 60),
  ("sentry_whoami", {}, 61),
  ("sentry_find_organizations", {}, 62),
  ("sentry_find_projects", {"organization_slug": "samui-science-lab"}, 63),
  ("sentry_search_issues", {"query": "is:unresolved", "limit": 5}, 64),
]
